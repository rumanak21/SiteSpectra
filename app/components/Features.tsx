        ...
        <div className="flex flex-col gap-y-[56px] py-[56px] lg:py-[120px] lg:gap-y-[80px]">
            <div className="flex flex-col gap-x-6 sm:flex-row-reverse">
                ...
                <div className='sm:w-1/2 lg:py-[56px] lg:pr-[56px]'>
                    ...
                    <ul className='flex flex-col gap-y-3 lg:text-[18px] '>
                        <li className='flex items-center gap-x-2 text-[#36485C] '><span></span> <Image src={Check} alt='Checked Mark' />Lorem ipsum dolor sit amet</li>
                    </ul>
                    <ul className='flex flex-col gap-y-3'>
                        <li className='flex items-center gap-x-2 text-[#36485C]'><span></span> <Image src={Check} alt='Checked Mark' />Consectetur adipiscing elit</li>
                    </ul>
                    <ul className='flex flex-col gap-y-3'>
                        <li className='flex items-center gap-x-2 text-[#36485C]'><span></span> <Image src={Check} alt='Checked Mark' />Sed do eiusmod tempor incididunt ut labore</li>
                    </ul>
                    <p className='pt-[24px] flex gap-x-2 text-[#0085FF] font-medium lg:text-[18px]'>Learn More <span><Image src={BlueButton} alt='Arrow Button' /></span></p>
                </div>
            </div>
            <div className="flex flex-col gap-x-6 sm:flex-row">
                ...
                <div className='sm:w-1/2 lg:py-[56px] lg:pl-[56px]'>
                    ...
                    <p className='pt-[24px] flex gap-x-2 text-[#00A424] font-medium lg:text-[18px]'>Learn More <span><Image src={GreenButton} alt='Arrow Button' /></span></p>
                </div>
            </div>
            <div className="flex flex-col gap-x-6 sm:flex-row-reverse">
                ...
                <div className='sm:w-1/2 lg:py-[56px] lg:pr-[56px]'>
                    ...
                    <p className='pt-[24px] flex gap-x-2 text-[#EB2891] font-medium lg:text-[18px]'>Learn More <span><Image src={PinkButton} alt='Arrow Button' /></span></p>
                </div>
            </div>
        </div>
    )
