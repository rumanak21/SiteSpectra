        ...
        <div className="pt-4 lg:pt-10">
            <div className="px-[20px] lg:px-[280px]">
                ...
                <div className="flex w-full pt-8 justify-center gap-x-6">
                    ...
                    <button className="w-1/2 text-[#4328EB] flex items-center justify-center gap-x-2 lg:w-fit">
                        View Pricing <span><Image src={BlueArrow} alt='learn more' /></span>
                    </button>
                </div>
            </div>
            <div className=' relative flex h-full w-full justify-center'>
                ...
                <div className='absolute bottom-5 flex w-full flex-col items-center'>
                    <Image src={HeroImage} alt='Hero Image' className='h-[310px] -ml-8 sm:-mb-20 sm:h-[400px] lg:-mb-28 lg:h-auto xl:w-[70%]' />

                    <div className='flex w-full flex-col items-center mb-14 lg:container lg:flex-row lg:justify-between lg:px-[20px]'>
                        <p className=' text-center text-[#FFFFFF] lg:text-[18px]'>Trusted by these companies</p>
                        <div className='grid grid-cols-3 items-center justify-center justify-items-center px-[20px] align-middle lg:grid-cols-5'>
                            <Image src={Google} alt='Google Icon' />
                            <Image src={Slack} alt=' Slack Icon' />
                            <Image src={TrustPilot} alt='TrustPilot Icon' />
                            <Image src={Cnn} alt='CNN Icon' />
